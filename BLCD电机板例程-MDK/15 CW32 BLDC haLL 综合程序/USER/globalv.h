...
#define  BUZZER_GPIO_PORT   CW_GPIOA
#define  BUZZERON()  {GPIO_WritePin(BUZZER_GPIO_PORT,BUZZER_GPIO_PIN,GPIO_Pin_RESET);}
#define  BUZZEROFF()  {GPIO_WritePin(BUZZER_GPIO_PORT,BUZZER_GPIO_PIN,GPIO_Pin_SET);}
//方向控制按键IO定义
